...
| 4 | **Encadenamiento:** Iniciar [Hito 1.9.4: Consultas de Usuario y RAG](file:///home/rmonla/Documentos/GitHub/rm-DiploIA_TPFI/app/hitos/1.9-dev/1.9.4_consulta_usuario_rag.md) para habilitar respuestas factuales. |
...
### D. Diagrama de Flujo: Rama 1 (Handshake)
```mermaid
graph TD
    A[Inicio Chat] --> B{Intencion}
    B -- "handshake" --> C[Google Sheets: Buscar Ticket]
    
    subgraph RutaSaludo [Flujo Saludo]
    C --> F{Existe Ticket}
